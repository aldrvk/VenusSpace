...
<body>
    <div class="container">
        <div class="header">
            <h1>Venus Hub</h1>
            <p style="margin: 5px 0 0 0;">Verifikasi Login</p>
        </div>

        <div class="content">
            <p>Halo,</p>
            <p>Seseorang baru saja mencoba masuk ke akun Venus Hub Anda. Untuk melanjutkan, masukkan kode verifikasi berikut:</p>
            ...
            <div class="warning">
                ⚠️ <strong>Penting:</strong> Jika Anda tidak mencoba masuk, abaikan email ini. Jangan pernah bagikan kode ini kepada siapa pun.
            </div>
