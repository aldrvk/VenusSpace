  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-20 flex flex-col items-center text-center gap-6 mt-16 md:mt-0">
        ...
        >
          Lebih dari sekadar tempat cuci mobil. Moderna Hub dirancang sebagai ruang jeda yang memadukan presisi otomotif dengan kultur lifestyle urban. Nongkrong, main, dan rawat kendaraan dalam satu ekosistem.
        </p>
