...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function BookingBengkel({ bookings, stalls, queueCount, pendingCount, filters: urlFilters }: Props) {
                ...
                {filteredBookings.length === 0 ? (
                    <div className="px-6 py-16 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-xs text-foreground/50 mt-1 max-w-xs">
                            Tidak ada data booking bengkel yang cocok dengan filter yang Anda pilih saat ini.
                        </p>
                    </div>
                ) : (
