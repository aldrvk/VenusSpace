...
export default function BengkelWalkIn() {
    const [customerName, setCustomerName] = useState('');
    const [customerEmail, setCustomerEmail] = useState('');
    const [selectedServiceId, setSelectedServiceId] = useState('servis_ringan');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/admin/bengkel/walk-in', {
    ...
    return (
        <AdminLayout>
            <Head title="Registrasi Walk-in – Bengkel Admin" />
