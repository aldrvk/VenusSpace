                    ...
                    if (window.snap) {
                        window.snap.pay(snapToken, {
                            onSuccess: function(result: any) {
                                axios.post(`/payment/local-success/${orderCode}`)
                                    .then(() => {
                                        ...
                                        window.location.href = `/coffee-shop/receipt?order_code=${orderCode}&method=${paymentMethod}&status=success`;
                                    })
                                    .catch(err => {
                            ...
                            onPending: function(result: any) {
                                localStorage.removeItem('venus_cart_coffee');
                                window.dispatchEvent(new Event('cart_updated'));
                                window.location.href = `/coffee-shop/receipt?order_code=${orderCode}&method=${paymentMethod}&status=pending`;
                            },
