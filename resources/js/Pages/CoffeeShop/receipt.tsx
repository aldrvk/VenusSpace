    ...
    if (!order) {
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center">
                ...
                <Link href="/coffee-shop" className="bg-primary text-primary-foreground px-6 py-2 rounded-full font-bold">Kembali Belanja</Link>
            </div>
        );
    }
                ...
                <div className="bg-card rounded-venus border border-border shadow-2xl overflow-hidden">
                    ...
                    <div className="bg-primary p-5 sm:p-8 text-center text-primary-foreground">
                        ...
                        <p className="text-primary-foreground/80 mt-2">
                            {isSelesai 
                                ? 'Pembayaran berhasil. Terima kasih atas pembelian Anda di Coffee Shop.' 
