...
export default function Receipt() {
    ...
    const orderNumber = "VNC-" + Math.floor(100000 + Math.random() * 900000);
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <Head title="Coffee Shop - Bukti Pembayaran" />
            <Navbar />
                ...
                <div className="bg-card rounded-venus border border-border shadow-2xl overflow-hidden">
                    ...
                    <div className={`${method === 'qris' ? 'bg-primary' : 'bg-secondary'} p-8 text-center text-primary-foreground`}>
                        ...
                        <p className="text-primary-foreground/80 mt-2">
                            {method === 'qris' ? 'Terima kasih atas kunjungan Anda di Coffee Shop' : 'Silakan lakukan pembayaran di kasir'}
                        </p>
                    </div>
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div className="bg-surface p-6 rounded-2xl border border-border text-center space-y-2">
                            <p className="text-body-reg text-foreground/60">
                                {method === 'qris' 
                                    ? 'Silakan tunjukkan bukti pembayaran ini ke barista untuk mengambil pesanan Anda.' 
                                    : 'Silakan tunjukkan nomor pesanan ini ke barista/kasir untuk melakukan pembayaran.'}
                            </p>
