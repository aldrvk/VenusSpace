                    ...
                    <div className="p-4 sm:p-8 space-y-6 sm:space-y-8">
                        ...
                        <div className="bg-surface p-6 rounded-2xl border border-border text-center space-y-2">
                            ...
                            <div className="pt-4 flex flex-wrap justify-center gap-3 no-print">
                                ...
                                <Link href={`/vape-store/tracking/${order.order_code}`} className="flex-1 sm:flex-none px-6 py-3 sm:py-2 bg-secondary text-white rounded-full text-label-sm hover:bg-secondary/90 transition-colors uppercase font-bold text-center">Lacak Pesanan</Link>
                                <Link href="/vape-store" className="flex-1 sm:flex-none px-6 py-3 sm:py-2 bg-super-black text-white rounded-full text-label-sm hover:bg-super-black/80 transition-colors uppercase font-bold text-center">Kembali</Link>
                            </div>
                        </div>
                    </div>
                </div>
